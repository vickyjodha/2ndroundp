...
<body
            ...
            <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
                ...
                <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                    <div class="kt-aside__brand-logo">
                        <a href="{{ route('dashboard') }}">
                            <img alt="Logo" src="{{ asset('assets/media/logos/view-white-admin-logo.png') }}" />
                        </a>
                    </div>
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--user">
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                                <div class="kt-header__topbar-user">
                                    ...
                                    <span
                                        class="kt-header__topbar-username kt-hidden-mobile">{{ \Auth::user()->name??"name" }}</span>
                            ...
                            <div
                                ...
                                <div class="kt-notification">
                                    ...
                                    <div class="kt-notification__custom kt-space-between">
                                        ...
                                        <a href="{{ route('dashboard') }}"
                                            class="btn btn-clean btn-sm btn-bold">Password Change</a>
                                    </div>
                ...
                <div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-footer__copyright">
                            {{ now()->year }}&nbsp;&copy;&nbsp;<a href="/"
                                class="kt-link text-capitalize">{{ \Config::get('app.name') }}</a>
                        </div>
                    </div>
                </div>
    ...
    @include('admin.layouts.message-toastr')
